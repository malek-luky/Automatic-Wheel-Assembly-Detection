...
def main() -> None:
    ...
    # Add the arguments
    parser.add_argument('filtered_data_path', type=str, help='The path to the filtered data')
    parser.add_argument('labels_data_path', type=str, help='The path to the labels data')
    parser.add_argument('normalized_data_path', type=str, help='The path to store the normalized data')
